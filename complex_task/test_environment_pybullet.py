...
drawer_id = p.loadURDF("/Users/balajis/Documents/Code/roboverse/roboverse/assets/bullet-objects/drawer/drawer_with_tray_inside.urdf", basePosition=[0.85, 0.2, 0.65], globalScaling=0.2)
...
for t in range(1400):
    ...
    if t >= 100 and t < 200:
        ...
        # target_pos, gripper_val = [0.85, -0.5, 0.97 + 0.001*(t-530)], 1 # move up after picking object
    ...
    #     target_pos, gripper_val = [0.85, 0.0 + 0.4*(t-650)/500., 1.1], 1 # move to target position
        ...
        # target_pos, gripper_val = [0.85, (-0.19 + (t-1200)*0.005), 0.97], 1 # Close drawer
    else:
        target_pos, gripper_val = [0.85, 0.0, 1.1], 0 # Come back to home pose
